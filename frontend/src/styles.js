...
@media(max-width:768px){.cp-btn{padding:10px}.cp-seek-wrap{height:28px}.cp-seek-track,.cp-seek-buffered,.cp-seek-progress,.cp-seek-sponsor{height:5px}.cp-seek-thumb{width:18px;height:18px;margin-top:-9px}.cp-chapters-panel{position:fixed;bottom:80px;right:auto;left:50%;transform:translateX(-50%);width:90vw;max-height:50vh}.custom-player{border-radius:0}.ch-settings-row{flex-wrap:wrap!important}.ch-settings-info{flex:1 1 100%!important}.ch-settings-btns{margin-left:38px}.cp-chapters-btn-wrap{display:none}}

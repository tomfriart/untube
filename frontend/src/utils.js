...
export const getApiKey = () => localStorage.getItem('untube_api_key') || ''
export const setApiKey = key => localStorage.setItem('untube_api_key', key)
